...
class PhysicsWorld: public DemoExample
{
	...
	void LoadDynamicsScene()
	{
		...
		const int height = 40;
		BuildJenga (m_viewer, this, osg::Vec3 (-5.0f, 5.0f, 2.0f), height);
		BuildJenga (m_viewer, this, osg::Vec3 ( 5.0f, 5.0f, 2.0f), height);
		BuildJenga (m_viewer, this, osg::Vec3 (-5.0f, 15.0f, 2.0f), height);
		BuildJenga (m_viewer, this, osg::Vec3 ( 5.0f, 15.0f, 2.0f), height);
		BuildPyramid (m_viewer, this, osg::Vec3 (0.0f, 25.0f, 0.0f), 10.0f, 30, 30);
	}
};
...
int main (int argc, char* argv[])
{
	...
	InitWindowsSystem (viewer, "Newton 3.12 and OpenSceneGraph integration: demo01 the basics", 100, 100, 1024, 768);
