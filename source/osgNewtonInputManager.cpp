...
newtonInputManager::newtonInputManager (newtonWorld* const world)
	:dNewtonInputManager(world)
	,m_world(world)
{
}

newtonInputManager::~newtonInputManager()
{
}


void newtonInputManager::OnBeginUpdate (dFloat timestepInSecunds)
{
	m_world->OnBeginUpdate(timestepInSecunds);
}

void newtonInputManager::OnEndUpdate (dFloat timestepInSecunds)
{
